                ...
                @forelse($offers as $o)
                    <tr>
                        ...
                        <td class="no-sort">
                            ...
                            <form action="{{ route('offers.destroy', $o->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('{{ __('Are you sure?') }}')">
                                @csrf @method('DELETE')
            ...
            const html = `
                ...
                <form action="${actionUrl}" method="POST">
                    ...
                    <div style="margin-bottom: 12px;">
                        <label style="display:block;font-size:12px;font-weight:600;color:var(--tx2);margin-bottom:4px;">{{ __('Offer Name') }}</label>
