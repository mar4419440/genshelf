...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'GenShelf is a high-performance POS and Inventory management system for modern retail businesses. Optimize your sales and stock management today.')">
    <meta name="keywords" content="@yield('meta_keywords', 'GenShelf, POS System, Inventory Management, Retail Software, Business Automation')">
    ...
    <meta property="og:description" content="@yield('meta_description', 'Manage your inventory and sales with the state-of-the-art GenShelf POS system.')">
  ...
  <div class="app-container">
      <div class="sidebar" id="app-sidebar">
        ...
        <div class="sidebar-actions">
            ...
            <button class="user-btn" onclick="document.getElementById('logout-form').submit();">{{ auth()->user()->displayName ?? auth()->user()->name }} ↗</button>
        </div>
      </div>
